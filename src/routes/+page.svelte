<script>
    ...
    counts.forEach(({key, delay}) => {
        tweens[key] = new Tween(0, {duration: 1000, easing: cubicOut, delay: delay})
    })
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="d-grid gap-2">
                            {#if key === "User"}
                                ...
                                <a class="btn btn-success" href="/users/create">Neuen Benutzer <i
                            ...
                            {:else if key === "Appointment"}
                                ...
                                <a class="btn btn-success" href="/appointments/create">Neuen Besichtigungstermin <i
