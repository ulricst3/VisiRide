<script>
    const {data, form, isCreation} = $props();
...
<form class="row g-3" method="POST" action={isCreation ? "?/create" : "?/update"}>
    ...
    <!-- FirstName -->
    <div class="col-md-6">
        <label for="inputFirstName" class="form-label" aria-label="Vorname">Vorname<span
                class="red-text">*</span></label>
        <input name="firstName" type="text" class="form-control" id="inputFirstName" bind:value={user.firstName}
               required>
    ...
    <!-- LastName -->
    <div class="col-md-6">
        <label for="inputLastName" class="form-label" aria-label="Nachname">Nachname<span
                class="red-text">*</span></label>
